...
| Skill path in repo | `/skills/ponytail-help` |
...
ln -s /absolute/path/to/skills/workmode/ponytail-help/ ./.claude/skills/ponytail-help
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\ponytail-help -Target E:\Project\Quantitative_Trading\skills\workmode/ponytail-help
```
...
2. Copy `/skills/ponytail-help` over `skills/workmode/ponytail-help/`, **preserving this `SOURCE.md`**.
