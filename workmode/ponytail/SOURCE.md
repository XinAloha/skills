...
| Skill path in repo | `/skills/ponytail` |
...
ln -s /absolute/path/to/skills/workmode/ponytail/ ./.claude/skills/ponytail
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\ponytail -Target E:\Project\Quantitative_Trading\skills\workmode/ponytail
```
...
2. Copy `/skills/ponytail` over `skills/workmode/ponytail/`, **preserving this `SOURCE.md`**.
