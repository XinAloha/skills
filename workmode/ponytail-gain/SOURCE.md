...
| Skill path in repo | `/skills/ponytail-gain` |
...
ln -s /absolute/path/to/skills/workmode/ponytail-gain/ ./.claude/skills/ponytail-gain
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\ponytail-gain -Target E:\Project\Quantitative_Trading\skills\workmode/ponytail-gain
```
...
2. Copy `/skills/ponytail-gain` over `skills/workmode/ponytail-gain/`, **preserving this `SOURCE.md`**.
