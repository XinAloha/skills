...
| skill | 何时用 |
|------|------|
| [manage-upward](manage-upward.md) | 接到上级 / 合作者任务、汇报进度、判断风险该不该报、申请资源；也用于让 AI 互相督促"打工人模式"（**人 ↔ 人** 协作） |
| [tame-vibe-coding](tame-vibe-coding.md) | 用 AI 大量生成代码、感觉"代码懂了又没懂"、不敢动 AI 写的某段、新人上手慢、合并前没仔细看 AI 输出（**人 ↔ AI** 协作，化解认知/技术债务） |
...
- `manage-upward` 与 `tame-vibe-coding` 是**协作双子**——前者管"人 ↔ 人"，后者管"人 ↔ AI"，覆盖打工人的双线沟通。
...
- `tame-vibe-coding` 与 [tdd](../methodology/tdd/SKILL.md) / [grill-with-docs](../methodology/grill-with-docs/SKILL.md) 联动——TDD 是它的"AI 先写测试"步骤，grill-with-docs 是它"复述验收"的强化版。
