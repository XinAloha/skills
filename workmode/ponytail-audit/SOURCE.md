...
| Skill path in repo | `/skills/ponytail-audit` |
...
ln -s /absolute/path/to/skills/workmode/ponytail-audit/ ./.claude/skills/ponytail-audit
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\ponytail-audit -Target E:\Project\Quantitative_Trading\skills\workmode/ponytail-audit
```
...
2. Copy `/skills/ponytail-audit` over `skills/workmode/ponytail-audit/`, **preserving this `SOURCE.md`**.
