...
| Skill path in repo | `/storage-analyzer` |
...
ln -s /absolute/path/to/skills/productivity/storage-analyzer/ ./.claude/skills/storage-analyzer
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\storage-analyzer -Target E:\Project\Quantitative_Trading\skills\productivity/storage-analyzer
```
...
2. Copy `/storage-analyzer` over `skills/productivity/storage-analyzer/`, **preserving this `SOURCE.md`**.
