...
| Skill path in repo | `/skills/dbs-spread` |
...
ln -s /absolute/path/to/skills/content/spread/ ./.claude/skills/spread
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\spread -Target E:\Project\Quantitative_Trading\skills\content/spread
```
...
2. Copy `/skills/dbs-spread` over `skills/content/spread/`, **preserving this `SOURCE.md`**.
