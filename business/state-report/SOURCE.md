...
| Skill path in repo | `/skills/dbs-report` |
...
ln -s /absolute/path/to/skills/business/state-report/ ./.claude/skills/state-report
# or, on Windows (PowerShell, admin):
# New-Item -ItemType Junction -Path .\.claude\skills\state-report -Target E:\Project\Quantitative_Trading\skills\business/state-report
```
...
2. Copy `/skills/dbs-report` over `skills/business/state-report/`, **preserving this `SOURCE.md`**.
